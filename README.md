...
- Doména integrace je `ha_egd_openapi`.
- Integrace používá `config_flow`.
- Typ integrace je `hub`.
- IoT třída je `cloud_polling`.
- Verze v manifestu: `1.0.0`.

## Stav projektu

Integrace je zaměřená na načítání dat měření z EG.D OpenAPI do statistik Home Assistantu. Pokud budete projekt rozšiřovat, dává smysl navázat například na:

- detailnější diagnostické entity,
- manuální spuštění synchronizace přes službu,
- rozšířenou dokumentaci k získání přístupových údajů,
- ukázkové nastavení pro Energy dashboard.

## Licence

Repozitář obsahuje soubor [`LICENSE`](/Users/coolajz/Documents/GitHub/ha_egd_openapi/LICENSE).
